...
set id 49
set name gsnh_gsnh_add_6ns_6ns_6_1_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename data_value \
    op interface \
    ports { data_value_address0 { O 18 vector } data_value_ce0 { O 1 bit } data_value_q0 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'data_value'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename data_grad \
    op interface \
    ports { data_grad_address0 { O 18 vector } data_grad_ce0 { O 1 bit } data_grad_q0 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'data_grad'"
}
}
