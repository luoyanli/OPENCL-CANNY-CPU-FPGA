...
`define AUTOTB_TVIN_gmem0  "./c.gsnh_gsnh.autotvin_gmem0.dat"
`define AUTOTB_TVIN_data  "./c.gsnh_gsnh.autotvin_data.dat"
`define AUTOTB_TVIN_out_r  "./c.gsnh_gsnh.autotvin_out_r.dat"
`define AUTOTB_TVIN_gmem0_out_wrapc  "./rtl.gsnh_gsnh.autotvin_gmem0.dat"
`define AUTOTB_TVIN_data_out_wrapc  "./rtl.gsnh_gsnh.autotvin_data.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "./rtl.gsnh_gsnh.autotvin_out_r.dat"
`define AUTOTB_TVOUT_gmem1  "./c.gsnh_gsnh.autotvout_gmem1.dat"
`define AUTOTB_TVOUT_gmem1_out_wrapc  "./impl_rtl.gsnh_gsnh.autotvout_gmem1.dat"
module `AUTOTB_TOP;
