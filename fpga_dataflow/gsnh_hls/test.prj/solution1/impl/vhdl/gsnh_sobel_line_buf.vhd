...
entity gsnh_sobel_line_buf_ram is 
    generic(
...
architecture rtl of gsnh_sobel_line_buf_ram is 
...
architecture arch of gsnh_sobel_line_buf is
    component gsnh_sobel_line_buf_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    gsnh_sobel_line_buf_ram_U :  component gsnh_sobel_line_buf_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
