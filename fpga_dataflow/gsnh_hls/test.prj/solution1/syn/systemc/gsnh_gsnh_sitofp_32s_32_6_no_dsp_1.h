...
// ==============================================================
#ifndef __gsnh_gsnh_sitofp_32s_32_6_no_dsp_1__HH__
#define __gsnh_gsnh_sitofp_32s_32_6_no_dsp_1__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(gsnh_gsnh_sitofp_32s_32_6_no_dsp_1) {
    ...
    SC_CTOR(gsnh_gsnh_sitofp_32s_32_6_no_dsp_1):  ACMP_sitofp_U ("ACMP_sitofp_U") {
