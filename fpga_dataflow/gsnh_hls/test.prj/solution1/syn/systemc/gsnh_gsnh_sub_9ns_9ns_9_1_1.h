...
// ==============================================================
#ifndef __gsnh_gsnh_sub_9ns_9ns_9_1_1__HH__
#define __gsnh_gsnh_sub_9ns_9ns_9_1_1__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(gsnh_gsnh_sub_9ns_9ns_9_1_1) {
    ...
    SC_CTOR(gsnh_gsnh_sub_9ns_9ns_9_1_1):  ACMP_sub_comb_U ("ACMP_sub_comb_U") {
