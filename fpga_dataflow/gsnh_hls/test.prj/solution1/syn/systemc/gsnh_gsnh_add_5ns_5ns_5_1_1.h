...
// ==============================================================
#ifndef __gsnh_gsnh_add_5ns_5ns_5_1_1__HH__
#define __gsnh_gsnh_add_5ns_5ns_5_1_1__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(gsnh_gsnh_add_5ns_5ns_5_1_1) {
    ...
    SC_CTOR(gsnh_gsnh_add_5ns_5ns_5_1_1):  ACMP_add_comb_U ("ACMP_add_comb_U") {
