...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /opt/xilinx/Vitis/2019.2/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /opt/xilinx/Vitis/2019.2/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /opt/xilinx/Vitis/2019.2/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /opt/xilinx/Vitis/2019.2/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "gsnh_gsnh.autotvin.dat"
	set constFileTvOut       "gsnh_gsnh.autotvout.dat"
	set constFileHdlTvIn     "gsnh_gsnh.autohdltvin.dat"
	set constFileHdlTvOut    "gsnh_gsnh.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
