...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.gsnh_gsnh.autotvin_gmem0.dat"
         "c.gsnh_gsnh.autotvin_data.dat"
         "c.gsnh_gsnh.autotvin_out_r.dat"
         "c.gsnh_gsnh.autotvout_gmem1.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.gsnh_gsnh.autotvout_gmem1.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
