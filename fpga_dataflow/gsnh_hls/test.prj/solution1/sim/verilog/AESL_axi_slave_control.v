...
//------------------------Parameter----------------------
`define TV_IN_data "../tv/cdatafile/c.gsnh_gsnh.autotvin_data.dat"
`define TV_IN_out_r "../tv/cdatafile/c.gsnh_gsnh.autotvin_out_r.dat"
parameter ADDR_WIDTH = 6;
parameter DATA_WIDTH = 32;
parameter data_DEPTH = 1;
reg [31 : 0] data_OPERATE_DEPTH = 1;
parameter data_c_bitwidth = 64;
parameter out_r_DEPTH = 1;
reg [31 : 0] out_r_OPERATE_DEPTH = 1;
parameter out_r_c_bitwidth = 64;
parameter START_ADDR = 0;
parameter gsnh_continue_addr = 0;
parameter gsnh_auto_start_addr = 0;
...
input    [64 - 1 : 0] TRAN_data;
input    [64 - 1 : 0] TRAN_out_r;
...
reg  BREADY_reg = 0;
reg [data_c_bitwidth - 1 : 0] reg_data;
...
assign TRAN_control_write_data_finish = 1 & data_write_data_finish & out_r_write_data_finish;
            ...
            if (write_data_run_flag === 1 && get_ack === 1) begin
                ...
                for (i = 0 ; i < four_byte_num ; i = i+1) begin
                    if (data_c_bitwidth < 32) begin
                        data_data_tmp_reg = reg_data;
                    end
                    else begin
                        for (j=0 ; j<32 ; j = j + 1) begin
                            if (i*32 + j < data_c_bitwidth) begin
                                data_data_tmp_reg[j] = reg_data[i*32 + j];
                            end
                            else begin
