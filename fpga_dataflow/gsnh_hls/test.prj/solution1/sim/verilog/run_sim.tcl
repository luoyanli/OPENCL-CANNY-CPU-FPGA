...
if {[file isfile gsnh_gsnh.autotvin.dat]} {
	file delete -force gsnh_gsnh.autotvin.dat
}

if {[file isfile gsnh_gsnh.autotvout.dat]} {
	file delete -force gsnh_gsnh.autotvout.dat
}
