...
`define AUTOTB_DUT      gsnh_gsnh
`define AUTOTB_DUT_INST AESL_inst_gsnh_gsnh
`define AUTOTB_TOP      apatb_gsnh_top
`define AUTOTB_LAT_RESULT_FILE "gsnh_gsnh.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "gsnh_gsnh.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_gsnh_top
...
`define AUTOTB_TVIN_out_r  "../tv/cdatafile/c.gsnh_gsnh.autotvin_out_r.dat"
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.gsnh_gsnh.autotvin_gmem0.dat"
`define AUTOTB_TVIN_data_out_wrapc  "../tv/rtldatafile/rtl.gsnh_gsnh.autotvin_data.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "../tv/rtldatafile/rtl.gsnh_gsnh.autotvin_out_r.dat"
`define AUTOTB_TVOUT_gmem1  "../tv/cdatafile/c.gsnh_gsnh.autotvout_gmem1.dat"
`define AUTOTB_TVOUT_gmem1_out_wrapc  "../tv/rtldatafile/rtl.gsnh_gsnh.autotvout_gmem1.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 1050950;
parameter LENGTH_gmem0 = 262144;
parameter LENGTH_gmem1 = 262144;
