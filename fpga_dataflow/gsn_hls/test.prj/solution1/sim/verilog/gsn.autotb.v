...
`define AUTOTB_DUT      gsn
`define AUTOTB_DUT_INST AESL_inst_gsn
`define AUTOTB_TOP      apatb_gsn_top
`define AUTOTB_LAT_RESULT_FILE "gsn.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "gsn.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_gsn_top
...
`define AUTOTB_TVIN_out_r  "../tv/cdatafile/c.gsn.autotvin_out_r.dat"
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.gsn.autotvin_gmem0.dat"
`define AUTOTB_TVIN_data_out_wrapc  "../tv/rtldatafile/rtl.gsn.autotvin_data.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "../tv/rtldatafile/rtl.gsn.autotvin_out_r.dat"
`define AUTOTB_TVOUT_gmem1  "../tv/cdatafile/c.gsn.autotvout_gmem1.dat"
`define AUTOTB_TVOUT_gmem1_out_wrapc  "../tv/rtldatafile/rtl.gsn.autotvout_gmem1.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 1053288;
