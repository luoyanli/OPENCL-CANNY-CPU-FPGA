...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "gsn.autotvin.dat"
	set constFileTvOut       "gsn.autotvout.dat"
	set constFileHdlTvIn     "gsn.autohdltvin.dat"
	set constFileHdlTvOut    "gsn.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
