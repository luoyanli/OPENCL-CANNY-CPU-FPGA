...
entity gsn_nms_line_buf_ram is 
    generic(
...
architecture rtl of gsn_nms_line_buf_ram is 
...
architecture arch of gsn_nms_line_buf is
    component gsn_nms_line_buf_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    gsn_nms_line_buf_ram_U :  component gsn_nms_line_buf_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
