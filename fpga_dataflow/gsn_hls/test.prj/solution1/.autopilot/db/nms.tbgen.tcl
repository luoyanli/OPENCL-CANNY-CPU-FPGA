...
set C_modelArgList {
	...
	{ data_0 int 8 regular {array 262144 { 1 3 } 1 1 }  }
	{ data_1 int 8 regular {array 262144 { 1 3 } 1 1 }  }
	{ out_r int 64 regular {fifo 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ data_0_address0 sc_out sc_lv 18 signal 1 } 
	{ data_0_ce0 sc_out sc_logic 1 signal 1 } 
	{ data_0_q0 sc_in sc_lv 8 signal 1 } 
	{ data_1_address0 sc_out sc_lv 18 signal 2 } 
	{ data_1_ce0 sc_out sc_logic 1 signal 2 } 
	{ data_1_q0 sc_in sc_lv 8 signal 2 } 
	{ out_r_dout sc_in sc_lv 64 signal 3 } 
	{ out_r_empty_n sc_in sc_logic 1 signal 3 } 
	{ out_r_read sc_out sc_logic 1 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "data_0_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "data_0", "role": "address0" }} , 
 	...
 	{ "name": "data_1_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "data_1", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "525850", "EstimateLatencyMax" : "525850",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			...
			{"Name" : "out_r", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "3",
				"BlockSignal" : [
					{"Name" : "out_r_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.line_buf_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_7ns_5ns_11_1_1_U27", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	nms {
		gmem1 {Type O LastRead 12 FirstWrite 14}
		data_0 {Type I LastRead 6 FirstWrite -1}
		data_1 {Type I LastRead 6 FirstWrite -1}
		out_r {Type I LastRead 0 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "525850", "Max" : "525850"}
	, {"Name" : "Interval", "Min" : "525850", "Max" : "525850"}
]}
...
set Spec2ImplPortList { 
	...
	data_0 { ap_memory {  { data_0_address0 mem_address 1 18 }  { data_0_ce0 mem_ce 1 1 }  { data_0_q0 mem_dout 0 8 } } }
	data_1 { ap_memory {  { data_1_address0 mem_address 1 18 }  { data_1_ce0 mem_ce 1 1 }  { data_1_q0 mem_dout 0 8 } } }
