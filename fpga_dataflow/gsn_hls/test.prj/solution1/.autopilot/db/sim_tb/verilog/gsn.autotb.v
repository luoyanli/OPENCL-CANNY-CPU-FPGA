...
`define AUTOTB_TVIN_gmem0  "./c.gsn.autotvin_gmem0.dat"
`define AUTOTB_TVIN_data  "./c.gsn.autotvin_data.dat"
`define AUTOTB_TVIN_out_r  "./c.gsn.autotvin_out_r.dat"
`define AUTOTB_TVIN_gmem0_out_wrapc  "./rtl.gsn.autotvin_gmem0.dat"
`define AUTOTB_TVIN_data_out_wrapc  "./rtl.gsn.autotvin_data.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "./rtl.gsn.autotvin_out_r.dat"
`define AUTOTB_TVOUT_gmem1  "./c.gsn.autotvout_gmem1.dat"
`define AUTOTB_TVOUT_gmem1_out_wrapc  "./impl_rtl.gsn.autotvout_gmem1.dat"
module `AUTOTB_TOP;
