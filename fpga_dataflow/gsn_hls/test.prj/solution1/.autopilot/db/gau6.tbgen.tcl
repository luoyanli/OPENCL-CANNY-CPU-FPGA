...
set C_modelArgList {
	...
	{ out1 int 64 regular  }
	{ out1_out int 64 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "out1_out", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ out1 sc_in sc_lv 64 signal 3 } 
	{ out1_out_din sc_out sc_lv 64 signal 4 } 
	{ out1_out_full_n sc_in sc_logic 1 signal 4 } 
	{ out1_out_write sc_out sc_logic 1 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out1_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "out1_out", "role": "din" }} , 
 	{ "name": "out1_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "out1_out", "role": "full_n" }} , 
 	{ "name": "out1_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "out1_out", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "out1_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "3",
				"BlockSignal" : [
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "263705", "Max" : "263705"}
	, {"Name" : "Interval", "Min" : "263705", "Max" : "263705"}
]}
...
set Spec2ImplPortList { 
	...
	out1_out { ap_fifo {  { out1_out_din fifo_data 1 64 }  { out1_out_full_n fifo_status 0 1 }  { out1_out_write fifo_update 1 1 } } }
}
