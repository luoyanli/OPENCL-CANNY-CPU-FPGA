...
extern "C" void gsn(char*, char*, int, int);
extern "C" void apatb_gsn_hw(volatile void * __xlx_apatb_param_data, volatile void * __xlx_apatb_param_out) {
  ...
  int __xlx_size_param_data = 262144;
  ...
  int __xlx_size_param_out = 262144;
  ...
  // DUT call
  gsn(__xlx_data__input_buffer, __xlx_out__input_buffer, __xlx_offset_byte_param_data, __xlx_offset_byte_param_out);
