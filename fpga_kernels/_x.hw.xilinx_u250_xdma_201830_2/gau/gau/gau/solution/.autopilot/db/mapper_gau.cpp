...
extern "C" void gau(__cosim_s64__*, __cosim_s64__*, int, int);
extern "C" void apatb_gau_hw(volatile void * __xlx_apatb_param_data, volatile void * __xlx_apatb_param_out_r) {
  ...
  // DUT call
  gau(__xlx_data__input_buffer, __xlx_out_r__input_buffer, __xlx_offset_byte_param_data, __xlx_offset_byte_param_out_r);
