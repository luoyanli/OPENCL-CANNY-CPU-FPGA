set moduleName nms_Pipeline_VITIS_LOOP_31_1_VITIS_LOOP_32_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {nms_Pipeline_VITIS_LOOP_31_1_VITIS_LOOP_32_2}
...
set C_modelArgList {
	...
	{ line_buf_value int 24 regular {array 512 { 0 1 } 1 1 }  }
	{ line_buf_grad int 24 regular {array 512 { 0 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "line_buf_value", "interface" : "memory", "bitwidth" : 24, "direction" : "READWRITE"} , 
 	{ "Name" : "line_buf_grad", "interface" : "memory", "bitwidth" : 24, "direction" : "READWRITE"} ]}
...
set portList { 
	...
	{ sext_ln31 sc_in sc_lv 58 signal 2 } 
	{ out_r sc_in sc_lv 64 signal 3 } 
	{ line_buf_value_address0 sc_out sc_lv 9 signal 4 } 
	{ line_buf_value_ce0 sc_out sc_logic 1 signal 4 } 
	{ line_buf_value_we0 sc_out sc_lv 3 signal 4 } 
	{ line_buf_value_d0 sc_out sc_lv 24 signal 4 } 
	{ line_buf_value_address1 sc_out sc_lv 9 signal 4 } 
	{ line_buf_value_ce1 sc_out sc_logic 1 signal 4 } 
	{ line_buf_value_q1 sc_in sc_lv 24 signal 4 } 
	{ line_buf_grad_address0 sc_out sc_lv 9 signal 5 } 
	{ line_buf_grad_ce0 sc_out sc_logic 1 signal 5 } 
	{ line_buf_grad_we0 sc_out sc_lv 3 signal 5 } 
	{ line_buf_grad_d0 sc_out sc_lv 24 signal 5 } 
	{ line_buf_grad_address1 sc_out sc_lv 9 signal 5 } 
	{ line_buf_grad_ce1 sc_out sc_logic 1 signal 5 } 
	{ line_buf_grad_q1 sc_in sc_lv 24 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "line_buf_value_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "line_buf_value", "role": "address1" }} , 
 	{ "name": "line_buf_value_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "line_buf_value", "role": "ce1" }} , 
 	{ "name": "line_buf_value_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "line_buf_value", "role": "q1" }} , 
 	...
 	{ "name": "line_buf_grad_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "line_buf_grad", "role": "address1" }} , 
 	{ "name": "line_buf_grad_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "line_buf_grad", "role": "ce1" }} , 
 	{ "name": "line_buf_grad_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "line_buf_grad", "role": "q1" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		"CDFG" : "nms_Pipeline_VITIS_LOOP_31_1_VITIS_LOOP_32_2",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "line_buf_value", "Type" : "Memory", "Direction" : "IO"},
			{"Name" : "line_buf_grad", "Type" : "Memory", "Direction" : "IO"}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_31_1_VITIS_LOOP_32_2", "PipelineType" : "pipeline",
...
set ArgLastReadFirstWriteLatency {
	nms_Pipeline_VITIS_LOOP_31_1_VITIS_LOOP_32_2 {
		gmem1 {Type O LastRead 4 FirstWrite 5}
		gmem0 {Type I LastRead 2 FirstWrite -1}
		sext_ln31 {Type I LastRead 0 FirstWrite -1}
		out_r {Type I LastRead 0 FirstWrite -1}
		line_buf_value {Type IO LastRead 2 FirstWrite 3}
		line_buf_grad {Type IO LastRead 2 FirstWrite 3}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "262216", "Max" : "262216"}
	, {"Name" : "Interval", "Min" : "262216", "Max" : "262216"}
]}
...
set Spec2ImplPortList { 
	...
	line_buf_value { ap_memory {  { line_buf_value_address0 mem_address 1 9 }  { line_buf_value_ce0 mem_ce 1 1 }  { line_buf_value_we0 mem_we 1 3 }  { line_buf_value_d0 mem_din 1 24 }  { line_buf_value_address1 MemPortADDR2 1 9 }  { line_buf_value_ce1 MemPortCE2 1 1 }  { line_buf_value_q1 in_data 0 24 } } }
	line_buf_grad { ap_memory {  { line_buf_grad_address0 mem_address 1 9 }  { line_buf_grad_ce0 mem_ce 1 1 }  { line_buf_grad_we0 mem_we 1 3 }  { line_buf_grad_d0 mem_din 1 24 }  { line_buf_grad_address1 MemPortADDR2 1 9 }  { line_buf_grad_ce1 MemPortCE2 1 1 }  { line_buf_grad_q1 in_data 0 24 } } }
}
