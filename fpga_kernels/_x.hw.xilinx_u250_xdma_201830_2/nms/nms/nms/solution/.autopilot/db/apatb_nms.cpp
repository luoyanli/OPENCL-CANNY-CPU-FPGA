...
// wrapc file define:
#define AUTOTB_TVIN_data "../tv/cdatafile/c.nms.autotvin_data.dat"
#define AUTOTB_TVOUT_data "../tv/cdatafile/c.nms.autotvout_data.dat"
#define AUTOTB_TVIN_out_r "../tv/cdatafile/c.nms.autotvin_out_r.dat"
#define AUTOTB_TVOUT_out_r "../tv/cdatafile/c.nms.autotvout_out_r.dat"
#define AUTOTB_TVIN_gmem0 "../tv/cdatafile/c.nms.autotvin_gmem0.dat"
#define AUTOTB_TVOUT_gmem0 "../tv/cdatafile/c.nms.autotvout_gmem0.dat"
#define AUTOTB_TVIN_gmem1 "../tv/cdatafile/c.nms.autotvin_gmem1.dat"
#define AUTOTB_TVOUT_gmem1 "../tv/cdatafile/c.nms.autotvout_gmem1.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_data "../tv/rtldatafile/rtl.nms.autotvout_data.dat"
#define AUTOTB_TVOUT_PC_out_r "../tv/rtldatafile/rtl.nms.autotvout_out_r.dat"
#define AUTOTB_TVOUT_PC_gmem0 "../tv/rtldatafile/rtl.nms.autotvout_gmem0.dat"
#define AUTOTB_TVOUT_PC_gmem1 "../tv/rtldatafile/rtl.nms.autotvout_gmem1.dat"
...
extern "C" void nms_hw_stub_wrapper(volatile void *, volatile void *);

extern "C" void apatb_nms_hw(volatile void * __xlx_apatb_param_data, volatile void * __xlx_apatb_param_out_r) {
...
{
transaction<8> tr(262144);
aesl_fh.read(AUTOTB_TVOUT_PC_gmem1, tr.p, tr.tbytes);
if (little_endian()) { tr.reorder(); }
tr.send<1>((char*)__xlx_apatb_param_out_r, 262144, 0);
}
#else
try {
static PostCheck<8> pc(AUTOTB_TVOUT_PC_gmem1);
pc.psize = 1;
...
transaction<512> tr(8192);
__xlx_offset_byte_param_data = 0*64;
if (__xlx_apatb_param_data) {
  tr.import<64>((char*)__xlx_apatb_param_data, 8192, 0);
}
...
if (__xlx_apatb_param_out_r) {
  tr.import<1>((char*)__xlx_apatb_param_out_r, 262144, 0);
}
aesl_fh.write(AUTOTB_TVIN_gmem1, tr.p, tr.tbytes);
tcl_file.set_num(262144, &tcl_file.gmem1_depth);
}
#else
...
unsigned char *pos = (unsigned char*)__xlx_apatb_param_out_r + i * 1;
...
nms_hw_stub_wrapper(__xlx_apatb_param_data, __xlx_apatb_param_out_r);
