...
extern "C" void nms(__cosim_s64__*, char*, int, int);
extern "C" void apatb_nms_hw(volatile void * __xlx_apatb_param_data, volatile void * __xlx_apatb_param_out_r) {
  ...
  int __xlx_size_param_data = 8192;
  ...
  // DUT call
  nms(__xlx_data__input_buffer, __xlx_out_r__input_buffer, __xlx_offset_byte_param_data, __xlx_offset_byte_param_out_r);
