...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir IO \
    corename line_buf_value \
    op interface \
    ports { line_buf_value_address0 { O 9 vector } line_buf_value_ce0 { O 1 bit } line_buf_value_we0 { O 3 vector } line_buf_value_d0 { O 24 vector } line_buf_value_address1 { O 9 vector } line_buf_value_ce1 { O 1 bit } line_buf_value_q1 { I 24 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'line_buf_value'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir IO \
    corename line_buf_grad \
    op interface \
    ports { line_buf_grad_address0 { O 9 vector } line_buf_grad_ce0 { O 1 bit } line_buf_grad_we0 { O 3 vector } line_buf_grad_d0 { O 24 vector } line_buf_grad_address1 { O 9 vector } line_buf_grad_ce1 { O 1 bit } line_buf_grad_q1 { I 24 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'line_buf_grad'"
}
}
