...
(* CORE_GENERATION_INFO = "bd_4bfa,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_4bfa,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=38,numReposBlks=30,numNonXlnxBlks=0,numHierBlks=8,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "bd_d216_interconnect_S00_AXI_0.hwdef" *) 
module bd_4bfa
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
