...
entity pfm_dynamic_debug_bridge_xsdbm_0_bd_ebbe is
  port (
  ...
  attribute HW_HANDOFF of pfm_dynamic_debug_bridge_xsdbm_0_bd_ebbe : entity is "pfm_dynamic_debug_bridge_xsdbm_0.hwdef";
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of pfm_dynamic_debug_bridge_xsdbm_0_bd_ebbe : entity is "bd_ebbe";
end pfm_dynamic_debug_bridge_xsdbm_0_bd_ebbe;

architecture STRUCTURE of pfm_dynamic_debug_bridge_xsdbm_0_bd_ebbe is
  component pfm_dynamic_debug_bridge_xsdbm_0_bd_ebbe_lut_buffer_0 is
  port (
    tdi_i : in STD_LOGIC;
    tms_i : in STD_LOGIC;
    tck_i : in STD_LOGIC;
  ...
  end component pfm_dynamic_debug_bridge_xsdbm_0_bd_ebbe_lut_buffer_0;
  component pfm_dynamic_debug_bridge_xsdbm_0_bd_ebbe_xsdbm_0 is
  port (
    update : in STD_LOGIC;
  ...
  end component pfm_dynamic_debug_bridge_xsdbm_0_bd_ebbe_xsdbm_0;
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN pfm_dynamic_clkwiz_sysclks_clk_out2, FREQ_HZ 50925925, INSERT_VIP 0, PHASE 0.000";
begin
lut_buffer: component pfm_dynamic_debug_bridge_xsdbm_0_bd_ebbe_lut_buffer_0
     port map (
...
xsdbm: component pfm_dynamic_debug_bridge_xsdbm_0_bd_ebbe_xsdbm_0
     port map (
...
entity pfm_dynamic_debug_bridge_xsdbm_0 is
  ...
  attribute NotValidForBitStream of pfm_dynamic_debug_bridge_xsdbm_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of pfm_dynamic_debug_bridge_xsdbm_0 : entity is "pfm_dynamic_debug_bridge_xsdbm_0,bd_ebbe,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of pfm_dynamic_debug_bridge_xsdbm_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of pfm_dynamic_debug_bridge_xsdbm_0 : entity is "bd_ebbe,Vivado 2018.3";
end pfm_dynamic_debug_bridge_xsdbm_0;

architecture STRUCTURE of pfm_dynamic_debug_bridge_xsdbm_0 is
  attribute HW_HANDOFF : string;
  ...
  attribute X_INTERFACE_INFO of clk : signal is "xilinx.com:signal:clock:1.0 CLK.clk CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.clk, FREQ_HZ 50925925, PHASE 0.000, CLK_DOMAIN pfm_dynamic_clkwiz_sysclks_clk_out2, INSERT_VIP 0";
begin
inst: entity work.pfm_dynamic_debug_bridge_xsdbm_0_bd_ebbe
     port map (
