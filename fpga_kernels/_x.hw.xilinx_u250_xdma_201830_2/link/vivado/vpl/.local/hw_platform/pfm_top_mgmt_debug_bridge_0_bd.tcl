...
################################################################
# This is a generated script based on design: bd_0301
#
...
proc create_root_design { parentCell } {
  ...
  set prim_bscan [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:bscan_rtl:1.0 prim_bscan ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_USE_MUX_STATUS {true} \
 ] $axi_jtag

  # Create instance: bs_mux, and set properties
  set bs_mux [ create_bd_cell -type ip -vlnv xilinx.com:ip:bs_mux:1.0 bs_mux ]
  set_property -dict [ list \
   CONFIG.C_BSCANID {76547072} \
 ] $bs_mux

  # Create instance: bs_switch, and set properties
  set bs_switch [ create_bd_cell -type ip -vlnv xilinx.com:ip:bs_switch:1.0 bs_switch ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net bs_mux_m_bscan [get_bd_intf_pins bs_mux/m_bscan] [get_bd_intf_pins bs_switch_1/s_bscan]
  connect_bd_intf_net -intf_net bs_switch_1_m0_bscan [get_bd_intf_ports m0_bscan] [get_bd_intf_pins bs_switch_1/m0_bscan]
  connect_bd_intf_net -intf_net bs_switch_m0_bscan [get_bd_intf_pins bs_mux/mux_ctrl_bs] [get_bd_intf_pins bs_switch/m0_bscan]
  connect_bd_intf_net -intf_net bs_switch_m1_bscan [get_bd_intf_pins bs_mux/prim_bscan] [get_bd_intf_pins bs_switch/m1_bscan]
  connect_bd_intf_net -intf_net bsip_m_bscan [get_bd_intf_pins bs_mux/soft_bscan] [get_bd_intf_pins bsip/m_bscan]
  connect_bd_intf_net -intf_net prim_bscan_1 [get_bd_intf_ports prim_bscan] [get_bd_intf_pins bs_switch/s_bscan]
  ...
  connect_bd_net -net bs_mux_mux [get_bd_pins axi_jtag/mux_status] [get_bd_pins bs_mux/mux]
