...
-- Date        : Wed Jun 26 22:05:43 2019
-- Host        : xsjl170276 running 64-bit CentOS Linux release 7.4.1708 (Core)
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ pfm_top_clkwiz_pcie_0_sim_netlist.vhdl
-- Design      : pfm_top_clkwiz_pcie_0
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pfm_top_clkwiz_pcie_0_clk_wiz is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pfm_top_clkwiz_pcie_0_clk_wiz;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pfm_top_clkwiz_pcie_0_clk_wiz is
  signal clk_out1_pfm_top_clkwiz_pcie_0 : STD_LOGIC;
...
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      CE_TYPE => "ASYNC"
        ...
        port map (
      CE => '1',
      I => clk_out1_pfm_top_clkwiz_pcie_0,
      O => clk_out1
    );
plle4_adv_inst: unisim.vcomponents.PLLE4_ADV
    generic map(
      ...
      CLKIN => clk_in1,
      CLKOUT0 => clk_out1_pfm_top_clkwiz_pcie_0,
...
begin
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pfm_top_clkwiz_pcie_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked,
