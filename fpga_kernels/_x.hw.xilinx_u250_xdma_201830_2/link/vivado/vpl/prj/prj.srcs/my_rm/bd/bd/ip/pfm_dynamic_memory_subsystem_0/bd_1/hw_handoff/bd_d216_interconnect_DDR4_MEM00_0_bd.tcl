...
################################################################
# This is a generated script based on design: bd_27a1
#
...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./prj/prj.srcs/my_rm/bd/bd/ip/pfm_dynamic_memory_subsystem_0/bd_1
...
proc create_hier_cell_s08_nodes { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_s08_nodes() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_s08_entry_pipeline { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_s08_entry_pipeline() - Empty argument(s)!"}
     return
  }
  ...
  set_property -dict [ list \
   ...
   CONFIG.SEG000_BASE_ADDR {0x0000004000000000} \
...
proc create_hier_cell_m00_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.RDATA_WIDTH {512} \
   CONFIG.READ_WRITE_MODE {READ_WRITE} \
   CONFIG.SSC000_ROUTE {0b000000001} \
   CONFIG.SSC001_ROUTE {0b000000010} \
   CONFIG.SSC002_ROUTE {0b000000100} \
   CONFIG.SSC003_ROUTE {0b000001000} \
   CONFIG.SSC004_ROUTE {0b000010000} \
   CONFIG.SSC005_ROUTE {0b000100000} \
   CONFIG.SSC006_ROUTE {0b001000000} \
   CONFIG.SSC007_ROUTE {0b010000000} \
   CONFIG.SSC008_ROUTE {0b100000000} \
   CONFIG.SSC009_ROUTE {0b000000000} \
   CONFIG.SSC010_ROUTE {0b000000000} \
   CONFIG.SSC011_ROUTE {0b000000000} \
   CONFIG.SSC012_ROUTE {0b000000000} \
   CONFIG.SSC013_ROUTE {0b000000000} \
   CONFIG.SSC014_ROUTE {0b000000000} \
   CONFIG.SSC015_ROUTE {0b000000000} \
   CONFIG.SSC_ROUTE_WIDTH {9} \
   CONFIG.S_ID_WIDTH {4} \
   CONFIG.WDATA_WIDTH {512} \
 ] $m00_exit
...
proc create_hier_cell_clk_map { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net clk_map_aclk1_net [get_bd_pins S00_ACLK] [get_bd_pins S01_ACLK] [get_bd_pins S02_ACLK] [get_bd_pins S03_ACLK] [get_bd_pins S04_ACLK] [get_bd_pins S05_ACLK] [get_bd_pins S06_ACLK] [get_bd_pins S07_ACLK] [get_bd_pins S08_ACLK] [get_bd_pins aclk1] [get_bd_pins psr0/slowest_sync_clk] [get_bd_pins psr_aclk1/slowest_sync_clk]
  ...
  connect_bd_net -net psr_aclk1_interconnect_aresetn [get_bd_pins S00_ARESETN] [get_bd_pins S01_ARESETN] [get_bd_pins S02_ARESETN] [get_bd_pins S03_ARESETN] [get_bd_pins S04_ARESETN] [get_bd_pins S05_ARESETN] [get_bd_pins S06_ARESETN] [get_bd_pins S07_ARESETN] [get_bd_pins S08_ARESETN] [get_bd_pins psr_aclk1/interconnect_aresetn]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net S_SC_AR_5 [get_bd_intf_pins s07_axi2sc/M_SC_AR] [get_bd_intf_pins s07_nodes/S_SC_AR]
  ...
  connect_bd_intf_net -intf_net S_SC_AW_5 [get_bd_intf_pins s08_axi2sc/M_SC_AW] [get_bd_intf_pins s08_nodes/S_SC_AW]
  ...
  connect_bd_intf_net -intf_net S_SC_B_5 [get_bd_intf_pins s08_nodes/S_SC_B] [get_bd_intf_pins switchboards/M08_SC_B]
  ...
  connect_bd_intf_net -intf_net S_SC_R_5 [get_bd_intf_pins s07_nodes/S_SC_R] [get_bd_intf_pins switchboards/M07_SC_R]
  ...
  connect_bd_intf_net -intf_net S_SC_W_5 [get_bd_intf_pins s08_axi2sc/M_SC_W] [get_bd_intf_pins s08_nodes/S_SC_W]
