...
proc create_hier_cell_reset_controllers_3 { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_reset_controllers_3() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_slr3 { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_slr3() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_slr0 { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins M01_AXI] [get_bd_intf_pins interconnect_axilite_user/M01_AXI]
  connect_bd_intf_net -intf_net Conn6 [get_bd_intf_pins M02_AXI] [get_bd_intf_pins interconnect_axilite_user/M02_AXI]
  connect_bd_intf_net -intf_net Conn7 [get_bd_intf_pins M03_AXI] [get_bd_intf_pins interconnect_axilite_user/M03_AXI]
  connect_bd_intf_net -intf_net Conn8 [get_bd_intf_pins M04_AXI] [get_bd_intf_pins interconnect_axilite_user/M04_AXI]
  connect_bd_intf_net -intf_net axi_cdc_data_dynamic_M_AXI [get_bd_intf_pins axi_cdc_data_M_AXI] [get_bd_intf_pins axi_cdc_data/M_AXI]
  connect_bd_intf_net -intf_net axi_user_interconnect_M00_AXI [get_bd_intf_pins axi_user_interconnect/M00_AXI] [get_bd_intf_pins axi_user_slrcrossing_mi/S_AXI]
  connect_bd_intf_net -intf_net axi_user_interconnect_M01_AXI [get_bd_intf_pins axi_user_interconnect/M01_AXI] [get_bd_intf_pins interconnect_axilite_user/S00_AXI]
  ...
  connect_bd_net -net clkwiz_kernel_clk_out1_1 [get_bd_pins clkwiz_kernel_clk_out1] [get_bd_pins axi_cdc_data/m_axi_aclk] [get_bd_pins freq_counter_0/test_clk0] [get_bd_pins interconnect_axilite_user/M01_ACLK] [get_bd_pins interconnect_axilite_user/M02_ACLK] [get_bd_pins interconnect_axilite_user/M03_ACLK] [get_bd_pins interconnect_axilite_user/M04_ACLK] [get_bd_pins reset_controllers/clkwiz_kernel_clk_out1]
  ...
  connect_bd_net -net reset_controllers_interconnect_aresetn1 [get_bd_pins psreset_gate_pr_kernel_interconnect_aresetn] [get_bd_pins axi_cdc_data/m_axi_aresetn] [get_bd_pins interconnect_axilite_user/M01_ARESETN] [get_bd_pins interconnect_axilite_user/M02_ARESETN] [get_bd_pins interconnect_axilite_user/M03_ARESETN] [get_bd_pins interconnect_axilite_user/M04_ARESETN] [get_bd_pins reset_controllers/psreset_gate_pr_kernel_interconnect_aresetn]
...
proc create_hier_cell_interrupt_concat { parentCell nameHier } {
  ...
  connect_bd_net -net In2_1 [get_bd_pins In2] [get_bd_pins xlconcat_interrupt_0/In2]
  connect_bd_net -net In3_1 [get_bd_pins In3] [get_bd_pins xlconcat_interrupt_0/In3]
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set c1_sys [ create_bd_port -dir I -type clk -freq_hz 300000000 c1_sys ]
  ...
  # Create instance: gau_1, and set properties
  set gau_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:gau:1.0 gau_1 ]

  # Create instance: hyst_1, and set properties
  ...
  # Create instance: nms_1, and set properties
  ...
  # Create instance: sobel_1, and set properties
  ...
  connect_bd_intf_net -intf_net gau_1_m_axi_gmem0 [get_bd_intf_pins gau_1/m_axi_gmem0] [get_bd_intf_pins memory_subsystem/S04_AXI]
  connect_bd_intf_net -intf_net gau_1_m_axi_gmem1 [get_bd_intf_pins gau_1/m_axi_gmem1] [get_bd_intf_pins memory_subsystem/S05_AXI]
  connect_bd_intf_net -intf_net hyst_1_m_axi_gmem0 [get_bd_intf_pins hyst_1/m_axi_gmem0] [get_bd_intf_pins memory_subsystem/S06_AXI]
  connect_bd_intf_net -intf_net hyst_1_m_axi_gmem1 [get_bd_intf_pins hyst_1/m_axi_gmem1] [get_bd_intf_pins memory_subsystem/S07_AXI]
  ...
  connect_bd_intf_net -intf_net nms_1_m_axi_gmem0 [get_bd_intf_pins memory_subsystem/S08_AXI] [get_bd_intf_pins nms_1/m_axi_gmem0]
  connect_bd_intf_net -intf_net nms_1_m_axi_gmem1 [get_bd_intf_pins memory_subsystem/S09_AXI] [get_bd_intf_pins nms_1/m_axi_gmem1]
  ...
  connect_bd_intf_net -intf_net slr0_M01_AXI [get_bd_intf_pins gau_1/s_axi_control] [get_bd_intf_pins slr0/M01_AXI]
  connect_bd_intf_net -intf_net slr0_M02_AXI [get_bd_intf_pins hyst_1/s_axi_control] [get_bd_intf_pins slr0/M02_AXI]
  connect_bd_intf_net -intf_net slr0_M03_AXI [get_bd_intf_pins nms_1/s_axi_control] [get_bd_intf_pins slr0/M03_AXI]
  connect_bd_intf_net -intf_net slr0_M04_AXI [get_bd_intf_pins slr0/M04_AXI] [get_bd_intf_pins sobel_1/s_axi_control]
  ...
  connect_bd_intf_net -intf_net sobel_1_m_axi_gmem0 [get_bd_intf_pins memory_subsystem/S10_AXI] [get_bd_intf_pins sobel_1/m_axi_gmem0]
  connect_bd_intf_net -intf_net sobel_1_m_axi_gmem1 [get_bd_intf_pins memory_subsystem/S11_AXI] [get_bd_intf_pins sobel_1/m_axi_gmem1]
  ...
  connect_bd_net -net clkwiz_kernel_clk_out1_1 [get_bd_ports clkwiz_kernel_clk_out1] [get_bd_pins gau_1/ap_clk] [get_bd_pins hyst_1/ap_clk] [get_bd_pins memory_subsystem/aclk] [get_bd_pins nms_1/ap_clk] [get_bd_pins slr0/clkwiz_kernel_clk_out1] [get_bd_pins slr1/clkwiz_kernel_clk_out1] [get_bd_pins slr2/clkwiz_kernel_clk_out1] [get_bd_pins slr3/clkwiz_kernel_clk_out1] [get_bd_pins sobel_1/ap_clk]
  ...
  connect_bd_net -net gau_1_interrupt [get_bd_pins gau_1/interrupt] [get_bd_pins interrupt_concat/In0]
  connect_bd_net -net hyst_1_interrupt [get_bd_pins hyst_1/interrupt] [get_bd_pins interrupt_concat/In1]
  ...
  connect_bd_net -net nms_1_interrupt [get_bd_pins interrupt_concat/In2] [get_bd_pins nms_1/interrupt]
  ...
  connect_bd_net -net slr0_peripheral_aresetn [get_bd_pins gau_1/ap_rst_n] [get_bd_pins hyst_1/ap_rst_n] [get_bd_pins nms_1/ap_rst_n] [get_bd_pins slr0/peripheral_aresetn] [get_bd_pins sobel_1/ap_rst_n]
  ...
  connect_bd_net -net sobel_1_interrupt [get_bd_pins interrupt_concat/In3] [get_bd_pins sobel_1/interrupt]

  # Create address segments
  assign_bd_address -offset 0x004000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces gau_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S04_AXI/DDR4_MEM00] -force
  assign_bd_address -offset 0x004000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces gau_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S05_AXI/DDR4_MEM00] -force
  assign_bd_address -offset 0x004000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces hyst_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S06_AXI/DDR4_MEM00] -force
  assign_bd_address -offset 0x004000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces hyst_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S07_AXI/DDR4_MEM00] -force
  assign_bd_address -offset 0x004000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces nms_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S08_AXI/DDR4_MEM00] -force
  assign_bd_address -offset 0x004000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces nms_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S09_AXI/DDR4_MEM00] -force
  assign_bd_address -offset 0x004000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces sobel_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S10_AXI/DDR4_MEM00] -force
  assign_bd_address -offset 0x004000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces sobel_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S11_AXI/DDR4_MEM00] -force
  assign_bd_address -offset 0x01FFC000 -range 0x00001000 -target_address_space [get_bd_addr_spaces regslice_control_userpf_M_AXI] [get_bd_addr_segs slr0/axi_gpio_null/S_AXI/Reg] -force
  assign_bd_address -offset 0x01FFD000 -range 0x00001000 -target_address_space [get_bd_addr_spaces regslice_control_userpf_M_AXI] [get_bd_addr_segs slr1/axi_gpio_null/S_AXI/Reg] -force
  assign_bd_address -offset 0x01FFE000 -range 0x00001000 -target_address_space [get_bd_addr_spaces regslice_control_userpf_M_AXI] [get_bd_addr_segs slr2/axi_gpio_null/S_AXI/Reg] -force
  assign_bd_address -offset 0x01FFF000 -range 0x00001000 -target_address_space [get_bd_addr_spaces regslice_control_userpf_M_AXI] [get_bd_addr_segs slr3/axi_gpio_null/S_AXI/Reg] -force
  assign_bd_address -offset 0x00052000 -range 0x00001000 -target_address_space [get_bd_addr_spaces regslice_control_periph_M_AXI] [get_bd_addr_segs slr0/freq_counter_0/axil/reg0] -force
  assign_bd_address -offset 0x01800000 -range 0x00010000 -target_address_space [get_bd_addr_spaces regslice_control_userpf_M_AXI] [get_bd_addr_segs gau_1/s_axi_control/Reg] -force
  assign_bd_address -offset 0x01810000 -range 0x00010000 -target_address_space [get_bd_addr_spaces regslice_control_userpf_M_AXI] [get_bd_addr_segs hyst_1/s_axi_control/Reg] -force
  ...
  assign_bd_address -offset 0x01000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces regslice_control_M_AXI] [get_bd_addr_segs memory_subsystem/S_AXI_CTRL/DDR4_MEM00_CTRL] -force
  assign_bd_address -offset 0x005000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces regslice_data_M_AXI_slr1] [get_bd_addr_segs memory_subsystem/S01_AXI/DDR4_MEM01] -force
  assign_bd_address -offset 0x01010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces regslice_control_M_AXI] [get_bd_addr_segs memory_subsystem/S_AXI_CTRL/DDR4_MEM01_CTRL] -force
  assign_bd_address -offset 0x006000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces regslice_data_M_AXI_slr2] [get_bd_addr_segs memory_subsystem/S02_AXI/DDR4_MEM02] -force
  assign_bd_address -offset 0x01020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces regslice_control_M_AXI] [get_bd_addr_segs memory_subsystem/S_AXI_CTRL/DDR4_MEM02_CTRL] -force
  assign_bd_address -offset 0x007000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces regslice_data_M_AXI_slr3] [get_bd_addr_segs memory_subsystem/S03_AXI/DDR4_MEM03] -force
  assign_bd_address -offset 0x01030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces regslice_control_M_AXI] [get_bd_addr_segs memory_subsystem/S_AXI_CTRL/DDR4_MEM03_CTRL] -force
  ...
  assign_bd_address -offset 0x003000200000 -range 0x00020000 -target_address_space [get_bd_addr_spaces regslice_data_M_AXI_slr1] [get_bd_addr_segs memory_subsystem/S01_AXI/PLRAM_MEM01] -force
  assign_bd_address -offset 0x003000400000 -range 0x00020000 -target_address_space [get_bd_addr_spaces regslice_data_M_AXI_slr2] [get_bd_addr_segs memory_subsystem/S02_AXI/PLRAM_MEM02] -force
  assign_bd_address -offset 0x003000600000 -range 0x00020000 -target_address_space [get_bd_addr_spaces regslice_data_M_AXI_slr3] [get_bd_addr_segs memory_subsystem/S03_AXI/PLRAM_MEM03] -force
  assign_bd_address -offset 0x01820000 -range 0x00010000 -target_address_space [get_bd_addr_spaces regslice_control_userpf_M_AXI] [get_bd_addr_segs nms_1/s_axi_control/Reg] -force
  assign_bd_address -offset 0x01830000 -range 0x00010000 -target_address_space [get_bd_addr_spaces regslice_control_userpf_M_AXI] [get_bd_addr_segs sobel_1/s_axi_control/Reg] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0x005000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces gau_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S04_AXI/DDR4_MEM01]
  exclude_bd_addr_seg -offset 0x006000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces gau_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S04_AXI/DDR4_MEM02]
  exclude_bd_addr_seg -offset 0x007000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces gau_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S04_AXI/DDR4_MEM03]
  exclude_bd_addr_seg -offset 0x003000000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces gau_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S04_AXI/PLRAM_MEM00]
  exclude_bd_addr_seg -offset 0x003000200000 -range 0x00020000 -target_address_space [get_bd_addr_spaces gau_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S04_AXI/PLRAM_MEM01]
  exclude_bd_addr_seg -offset 0x003000400000 -range 0x00020000 -target_address_space [get_bd_addr_spaces gau_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S04_AXI/PLRAM_MEM02]
  exclude_bd_addr_seg -offset 0x003000600000 -range 0x00020000 -target_address_space [get_bd_addr_spaces gau_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S04_AXI/PLRAM_MEM03]
  exclude_bd_addr_seg -offset 0x005000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces gau_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S05_AXI/DDR4_MEM01]
  exclude_bd_addr_seg -offset 0x006000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces gau_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S05_AXI/DDR4_MEM02]
  exclude_bd_addr_seg -offset 0x007000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces gau_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S05_AXI/DDR4_MEM03]
  exclude_bd_addr_seg -offset 0x003000000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces gau_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S05_AXI/PLRAM_MEM00]
  exclude_bd_addr_seg -offset 0x003000200000 -range 0x00020000 -target_address_space [get_bd_addr_spaces gau_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S05_AXI/PLRAM_MEM01]
  exclude_bd_addr_seg -offset 0x003000400000 -range 0x00020000 -target_address_space [get_bd_addr_spaces gau_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S05_AXI/PLRAM_MEM02]
  exclude_bd_addr_seg -offset 0x003000600000 -range 0x00020000 -target_address_space [get_bd_addr_spaces gau_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S05_AXI/PLRAM_MEM03]
  exclude_bd_addr_seg -offset 0x005000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces hyst_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S06_AXI/DDR4_MEM01]
  exclude_bd_addr_seg -offset 0x006000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces hyst_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S06_AXI/DDR4_MEM02]
  exclude_bd_addr_seg -offset 0x007000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces hyst_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S06_AXI/DDR4_MEM03]
  exclude_bd_addr_seg -offset 0x003000000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces hyst_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S06_AXI/PLRAM_MEM00]
  exclude_bd_addr_seg -offset 0x003000200000 -range 0x00020000 -target_address_space [get_bd_addr_spaces hyst_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S06_AXI/PLRAM_MEM01]
  exclude_bd_addr_seg -offset 0x003000400000 -range 0x00020000 -target_address_space [get_bd_addr_spaces hyst_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S06_AXI/PLRAM_MEM02]
  exclude_bd_addr_seg -offset 0x003000600000 -range 0x00020000 -target_address_space [get_bd_addr_spaces hyst_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S06_AXI/PLRAM_MEM03]
  exclude_bd_addr_seg -offset 0x005000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces hyst_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S07_AXI/DDR4_MEM01]
  exclude_bd_addr_seg -offset 0x006000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces hyst_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S07_AXI/DDR4_MEM02]
  exclude_bd_addr_seg -offset 0x007000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces hyst_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S07_AXI/DDR4_MEM03]
  exclude_bd_addr_seg -offset 0x003000000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces hyst_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S07_AXI/PLRAM_MEM00]
  exclude_bd_addr_seg -offset 0x003000200000 -range 0x00020000 -target_address_space [get_bd_addr_spaces hyst_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S07_AXI/PLRAM_MEM01]
  exclude_bd_addr_seg -offset 0x003000400000 -range 0x00020000 -target_address_space [get_bd_addr_spaces hyst_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S07_AXI/PLRAM_MEM02]
  exclude_bd_addr_seg -offset 0x003000600000 -range 0x00020000 -target_address_space [get_bd_addr_spaces hyst_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S07_AXI/PLRAM_MEM03]
  exclude_bd_addr_seg -offset 0x005000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces nms_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S08_AXI/DDR4_MEM01]
  exclude_bd_addr_seg -offset 0x006000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces nms_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S08_AXI/DDR4_MEM02]
  exclude_bd_addr_seg -offset 0x007000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces nms_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S08_AXI/DDR4_MEM03]
  exclude_bd_addr_seg -offset 0x003000000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces nms_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S08_AXI/PLRAM_MEM00]
  exclude_bd_addr_seg -offset 0x003000200000 -range 0x00020000 -target_address_space [get_bd_addr_spaces nms_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S08_AXI/PLRAM_MEM01]
  exclude_bd_addr_seg -offset 0x003000400000 -range 0x00020000 -target_address_space [get_bd_addr_spaces nms_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S08_AXI/PLRAM_MEM02]
  exclude_bd_addr_seg -offset 0x003000600000 -range 0x00020000 -target_address_space [get_bd_addr_spaces nms_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S08_AXI/PLRAM_MEM03]
  exclude_bd_addr_seg -offset 0x005000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces nms_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S09_AXI/DDR4_MEM01]
  exclude_bd_addr_seg -offset 0x006000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces nms_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S09_AXI/DDR4_MEM02]
  exclude_bd_addr_seg -offset 0x007000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces nms_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S09_AXI/DDR4_MEM03]
  exclude_bd_addr_seg -offset 0x003000000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces nms_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S09_AXI/PLRAM_MEM00]
  exclude_bd_addr_seg -offset 0x003000200000 -range 0x00020000 -target_address_space [get_bd_addr_spaces nms_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S09_AXI/PLRAM_MEM01]
  exclude_bd_addr_seg -offset 0x003000400000 -range 0x00020000 -target_address_space [get_bd_addr_spaces nms_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S09_AXI/PLRAM_MEM02]
  exclude_bd_addr_seg -offset 0x003000600000 -range 0x00020000 -target_address_space [get_bd_addr_spaces nms_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S09_AXI/PLRAM_MEM03]
  exclude_bd_addr_seg -offset 0x005000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces sobel_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S10_AXI/DDR4_MEM01]
  exclude_bd_addr_seg -offset 0x006000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces sobel_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S10_AXI/DDR4_MEM02]
  exclude_bd_addr_seg -offset 0x007000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces sobel_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S10_AXI/DDR4_MEM03]
  exclude_bd_addr_seg -offset 0x003000000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces sobel_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S10_AXI/PLRAM_MEM00]
  exclude_bd_addr_seg -offset 0x003000200000 -range 0x00020000 -target_address_space [get_bd_addr_spaces sobel_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S10_AXI/PLRAM_MEM01]
  exclude_bd_addr_seg -offset 0x003000400000 -range 0x00020000 -target_address_space [get_bd_addr_spaces sobel_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S10_AXI/PLRAM_MEM02]
  exclude_bd_addr_seg -offset 0x003000600000 -range 0x00020000 -target_address_space [get_bd_addr_spaces sobel_1/Data_m_axi_gmem0] [get_bd_addr_segs memory_subsystem/S10_AXI/PLRAM_MEM03]
  exclude_bd_addr_seg -offset 0x005000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces sobel_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S11_AXI/DDR4_MEM01]
  exclude_bd_addr_seg -offset 0x006000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces sobel_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S11_AXI/DDR4_MEM02]
  exclude_bd_addr_seg -offset 0x007000000000 -range 0x000400000000 -target_address_space [get_bd_addr_spaces sobel_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S11_AXI/DDR4_MEM03]
  exclude_bd_addr_seg -offset 0x003000000000 -range 0x00020000 -target_address_space [get_bd_addr_spaces sobel_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S11_AXI/PLRAM_MEM00]
  exclude_bd_addr_seg -offset 0x003000200000 -range 0x00020000 -target_address_space [get_bd_addr_spaces sobel_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S11_AXI/PLRAM_MEM01]
  exclude_bd_addr_seg -offset 0x003000400000 -range 0x00020000 -target_address_space [get_bd_addr_spaces sobel_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S11_AXI/PLRAM_MEM02]
  exclude_bd_addr_seg -offset 0x003000600000 -range 0x00020000 -target_address_space [get_bd_addr_spaces sobel_1/Data_m_axi_gmem1] [get_bd_addr_segs memory_subsystem/S11_AXI/PLRAM_MEM03]
  ...
  set_property HDL_ATTRIBUTE.LOCKED {true} [get_bd_intf_ports ddrmem_1_C0_DDR4]
  ...
  set_property HDL_ATTRIBUTE.LOCKED {true} [get_bd_intf_ports regslice_control_M_AXI]
  set_property HDL_ATTRIBUTE.LOCKED {true} [get_bd_intf_ports regslice_control_periph_M_AXI]
  ...
  set_property HDL_ATTRIBUTE.LOCKED {true} [get_bd_intf_ports regslice_data_M_AXI_slr1]
  set_property HDL_ATTRIBUTE.LOCKED {true} [get_bd_intf_ports regslice_data_M_AXI_slr2]
  set_property HDL_ATTRIBUTE.LOCKED {true} [get_bd_intf_ports regslice_data_M_AXI_slr3]
