...
void XNms_Continue(XNms *InstancePtr) {
    u32 Data;
    ...
    Data = XNms_ReadReg(InstancePtr->Control_BaseAddress, XNMS_CONTROL_ADDR_AP_CTRL) & 0x80;
    XNms_WriteReg(InstancePtr->Control_BaseAddress, XNMS_CONTROL_ADDR_AP_CTRL, Data | 0x10);
}
...
void XNms_Set_data(XNms *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XNms_WriteReg(InstancePtr->Control_BaseAddress, XNMS_CONTROL_ADDR_DATA_DATA, (u32)(Data));
    XNms_WriteReg(InstancePtr->Control_BaseAddress, XNMS_CONTROL_ADDR_DATA_DATA + 4, (u32)(Data >> 32));
}

u64 XNms_Get_data(XNms *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XNms_ReadReg(InstancePtr->Control_BaseAddress, XNMS_CONTROL_ADDR_DATA_DATA);
    Data += (u64)XNms_ReadReg(InstancePtr->Control_BaseAddress, XNMS_CONTROL_ADDR_DATA_DATA + 4) << 32;
    return Data;
}

void XNms_Set_out_r(XNms *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XNms_WriteReg(InstancePtr->Control_BaseAddress, XNMS_CONTROL_ADDR_OUT_R_DATA, (u32)(Data));
    XNms_WriteReg(InstancePtr->Control_BaseAddress, XNMS_CONTROL_ADDR_OUT_R_DATA + 4, (u32)(Data >> 32));
}

u64 XNms_Get_out_r(XNms *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XNms_ReadReg(InstancePtr->Control_BaseAddress, XNMS_CONTROL_ADDR_OUT_R_DATA);
    Data += (u64)XNms_ReadReg(InstancePtr->Control_BaseAddress, XNMS_CONTROL_ADDR_OUT_R_DATA + 4) << 32;
    return Data;
}
