...
#define XSOBEL_CONTROL_ADDR_DATA_DATA  0x10
#define XSOBEL_CONTROL_BITS_DATA_DATA  64
#define XSOBEL_CONTROL_ADDR_OUT_R_DATA 0x1c
#define XSOBEL_CONTROL_BITS_OUT_R_DATA 64
