...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "nms.autotvin.dat"
	set constFileTvOut       "nms.autotvout.dat"
	set constFileHdlTvIn     "nms.autohdltvin.dat"
	set constFileHdlTvOut    "nms.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
