...
architecture rtl of nms_line_buf_ram is 
...
architecture arch of nms_line_buf is
    component nms_line_buf_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    nms_line_buf_ram_U :  component nms_line_buf_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
