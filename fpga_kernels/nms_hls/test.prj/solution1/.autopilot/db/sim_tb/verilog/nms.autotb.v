...
`define AUTOTB_DUT      nms
`define AUTOTB_DUT_INST AESL_inst_nms
`define AUTOTB_TOP      apatb_nms_top
`define AUTOTB_LAT_RESULT_FILE "nms.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "nms.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_nms_top
...
`define AUTOTB_TVIN_data  "./c.nms.autotvin_data.dat"
`define AUTOTB_TVIN_out_r  "./c.nms.autotvin_out_r.dat"
`define AUTOTB_TVIN_data_out_wrapc  "./rtl.nms.autotvin_data.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "./rtl.nms.autotvin_out_r.dat"
`define AUTOTB_TVOUT_out_r  "./c.nms.autotvout_out_r.dat"
`define AUTOTB_TVOUT_out_r_out_wrapc  "./impl_rtl.nms.autotvout_out_r.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 134158;
parameter LENGTH_data = 65536;
...
wire ap_idle;
wire ap_ready;
wire [15 : 0] data_address0;
wire  data_ce0;
wire [15 : 0] data_q0;
wire [15 : 0] out_r_address0;
wire  out_r_ce0;
wire  out_r_we0;
wire [7 : 0] out_r_d0;
integer done_cnt = 0;
...
wire [2 - 1 : 0]    arraydata_we0, arraydata_we1;
wire    [15 : 0]    arraydata_address0, arraydata_address1;
wire    [15 : 0]    arraydata_din0, arraydata_din1;
wire    [15 : 0]    arraydata_dout0, arraydata_dout1;
...
wire [1 - 1 : 0]    arrayout_r_we0, arrayout_r_we1;
wire    [15 : 0]    arrayout_r_address0, arrayout_r_address1;
wire    [7 : 0]    arrayout_r_din0, arrayout_r_din1;
wire    [7 : 0]    arrayout_r_dout0, arrayout_r_dout1;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.nms.autotvout_out_r.dat", "r");
    fp2 = $fopen("./impl_rtl.nms.autotvout_out_r.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.nms.autotvout_out_r.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.nms.autotvout_out_r.dat\"!");
    else begin
        $display("Comparing rtl.nms.autotvout_out_r.dat with impl_rtl.nms.autotvout_out_r.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
