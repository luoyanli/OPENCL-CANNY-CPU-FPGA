...
set C_modelArgList {
	{ data int 16 regular {array 65536 { 1 3 } 1 1 }  }
	{ out_r int 8 regular {array 65536 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "data", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[{"low":0,"up":15,"cElement": [{"cName": "data","cData": "short","bit_use": { "low": 0,"up": 15},"cArray": [{"low" : 0,"up" : 65535,"step" : 1}]}]}]} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "134158", "EstimateLatencyMax" : "134158",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_7ns_5ns_11_1_1_U1", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "134158", "Max" : "134158"}
	, {"Name" : "Interval", "Min" : "134159", "Max" : "134159"}
]}
...
set Spec2ImplPortList { 
	data { ap_memory {  { data_address0 mem_address 1 16 }  { data_ce0 mem_ce 1 1 }  { data_q0 mem_dout 0 16 } } }
