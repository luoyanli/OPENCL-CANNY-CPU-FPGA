...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "gau.autotvin.dat"
	set constFileTvOut       "gau.autotvout.dat"
	set constFileHdlTvIn     "gau.autohdltvin.dat"
	set constFileHdlTvOut    "gau.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
