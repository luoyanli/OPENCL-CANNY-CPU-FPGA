...
architecture rtl of gau_line_buf_ram is 
...
architecture arch of gau_line_buf is
    component gau_line_buf_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    gau_line_buf_ram_U :  component gau_line_buf_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
