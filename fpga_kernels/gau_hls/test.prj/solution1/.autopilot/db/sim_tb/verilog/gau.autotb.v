...
`define AUTOTB_DUT      gau
`define AUTOTB_DUT_INST AESL_inst_gau
`define AUTOTB_TOP      apatb_gau_top
`define AUTOTB_LAT_RESULT_FILE "gau.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "gau.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_gau_top
...
`define AUTOTB_TVIN_data  "./c.gau.autotvin_data.dat"
`define AUTOTB_TVIN_out_r  "./c.gau.autotvin_out_r.dat"
`define AUTOTB_TVIN_data_out_wrapc  "./rtl.gau.autotvin_data.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "./rtl.gau.autotvin_out_r.dat"
`define AUTOTB_TVOUT_out_r  "./c.gau.autotvout_out_r.dat"
`define AUTOTB_TVOUT_out_r_out_wrapc  "./impl_rtl.gau.autotvout_out_r.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 68110;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.gau.autotvout_out_r.dat", "r");
    fp2 = $fopen("./impl_rtl.gau.autotvout_out_r.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.gau.autotvout_out_r.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.gau.autotvout_out_r.dat\"!");
    else begin
        $display("Comparing rtl.gau.autotvout_out_r.dat with impl_rtl.gau.autotvout_out_r.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
