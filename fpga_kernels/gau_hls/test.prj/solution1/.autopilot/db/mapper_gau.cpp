...
extern "C" void gau(char*, char*);
extern "C" void apatb_gau_hw(volatile void * __xlx_apatb_param_data, volatile void * __xlx_apatb_param_out) {
  ...
  // DUT call
  gau(__xlx_data__input_buffer, __xlx_out__input_buffer);
