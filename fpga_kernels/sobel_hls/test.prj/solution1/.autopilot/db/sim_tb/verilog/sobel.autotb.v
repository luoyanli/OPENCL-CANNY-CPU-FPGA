...
`define AUTOTB_TVIN_data  "./c.sobel.autotvin_data.dat"
`define AUTOTB_TVIN_out_r  "./c.sobel.autotvin_out_r.dat"
`define AUTOTB_TVIN_data_out_wrapc  "./rtl.sobel.autotvin_data.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "./rtl.sobel.autotvin_out_r.dat"
`define AUTOTB_TVOUT_out_r  "./c.sobel.autotvout_out_r.dat"
`define AUTOTB_TVOUT_out_r_out_wrapc  "./impl_rtl.sobel.autotvout_out_r.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 76046;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.sobel.autotvout_out_r.dat", "r");
    fp2 = $fopen("./impl_rtl.sobel.autotvout_out_r.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.sobel.autotvout_out_r.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.sobel.autotvout_out_r.dat\"!");
    else begin
        $display("Comparing rtl.sobel.autotvout_out_r.dat with impl_rtl.sobel.autotvout_out_r.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
