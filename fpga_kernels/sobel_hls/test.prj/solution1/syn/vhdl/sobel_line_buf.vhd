...
architecture rtl of sobel_line_buf_ram is 
...
architecture arch of sobel_line_buf is
    component sobel_line_buf_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    sobel_line_buf_ram_U :  component sobel_line_buf_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
