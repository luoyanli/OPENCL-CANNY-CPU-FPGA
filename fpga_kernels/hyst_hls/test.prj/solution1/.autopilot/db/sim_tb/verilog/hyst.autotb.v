...
`define AUTOTB_DUT      hyst
`define AUTOTB_DUT_INST AESL_inst_hyst
`define AUTOTB_TOP      apatb_hyst_top
`define AUTOTB_LAT_RESULT_FILE "hyst.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "hyst.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_hyst_top
...
`define AUTOTB_TVIN_data  "./c.hyst.autotvin_data.dat"
`define AUTOTB_TVIN_out_r  "./c.hyst.autotvin_out_r.dat"
`define AUTOTB_TVIN_data_out_wrapc  "./rtl.hyst.autotvin_data.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "./rtl.hyst.autotvin_out_r.dat"
`define AUTOTB_TVOUT_out_r  "./c.hyst.autotvout_out_r.dat"
`define AUTOTB_TVOUT_out_r_out_wrapc  "./impl_rtl.hyst.autotvout_out_r.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 66817;
...
wire [1 - 1 : 0]    arraydata_we0, arraydata_we1;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.hyst.autotvout_out_r.dat", "r");
    fp2 = $fopen("./impl_rtl.hyst.autotvout_out_r.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.hyst.autotvout_out_r.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.hyst.autotvout_out_r.dat\"!");
    else begin
        $display("Comparing rtl.hyst.autotvout_out_r.dat with impl_rtl.hyst.autotvout_out_r.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
