...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /opt/xilinx/Vitis/2020.1/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /opt/xilinx/Vitis/2020.1/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /opt/xilinx/Vitis/2020.1/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /opt/xilinx/Vitis/2020.1/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hyst.autotvin.dat"
	set constFileTvOut       "hyst.autotvout.dat"
	set constFileHdlTvIn     "hyst.autohdltvin.dat"
	set constFileHdlTvOut    "hyst.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
